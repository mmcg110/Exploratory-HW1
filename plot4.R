...
##3. Generate Plot4. Create a "Date_time" column using "strptime" to convert to date format. Generate plot and save as PNG
...
with(data3, plot(Date_time, Voltage, type = "n")); with(data3, lines(Date_time, Voltage))
...
with( data3, plot(Date_time, Global_reactive_power, type = "n")); with(data3, lines(Date_time, Global_reactive_power))
